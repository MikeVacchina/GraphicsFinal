...
GLint loc_position;
GLint loc_color;
//GLint loc_norm; //commented out just so it can compile
...
void render()
{
    ...
    //glEnableVertexAttribArray(loc_norm); //commented out just so it can compile
    ...
    //glVertexAttribPointer( loc_norm,						  //commented out just so it can compile
    //                       3,								  //commented out just so it can compile
    //                       GL_FLOAT,						  //commented out just so it can compile
    //                       GL_FALSE,						  //commented out just so it can compile
    //                       sizeof(Vertex),				  //commented out just so it can compile
    //                       (void*)offsetof(Vertex,normal)); //commented out just so it can compile
    ...
    //glDisableVertexAttribArray(loc_norm); //commented out just so it can compile
