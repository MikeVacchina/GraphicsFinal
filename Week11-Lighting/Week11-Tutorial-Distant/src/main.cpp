...
glm::vec4 DP = glm::vec4(0.2,0.8,0.7,1.0);
glm::vec4 SP = glm::vec4(0.5,0.9,0.5,1.0);
...
int main(int argc, char **argv)
{
    ...
    glutCreateWindow("Distant Light Example");
...
bool initialize()
{
    ...
    {
        std::cerr << "[F] DISTANTLIGHTDIRECTION NOT FOUND" << std::endl;
        return false;
    }
